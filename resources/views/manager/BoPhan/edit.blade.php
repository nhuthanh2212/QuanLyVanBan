...
<div class="content">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Cập Nhật bophan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{URL::to('/home')}}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{Route( 'bo-phan.index')}}">Danh Sách bophan</a></li>
              <li class="breadcrumb-item active">Cập Nhật bophan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form method="post" action="{{route('bo-phan.update',[$bophan->id])}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tên bophan: </label>
                    <input type="text" class="form-control" value="{{$bophan->Tenbophan}}" name="TenBP" id="exampleInputEmail1" placeholder="...">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                                ...
                                <select name="id_PB" class="form-control input-sm m-bot15">
                                    ...
                                    <option value="{{$pb->id}}" {{ $pb->id == $bophan->id ? 'selected="selected"' : '' }}>{{$pb->TenPB}}</option>
                                    @endforeach
