...
<div class="content">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Cập Nhật Đơn Vị Cấp Cao</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{URL::to('/home')}}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{Route( 'don-vi-cap-cao.index')}}">Danh Sách Đơn Vị Cấp Cao</a></li>
              <li class="breadcrumb-item active">Cập Nhật Đơn Vị Cấp Cao</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
 ...
 <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{route('don-vi-cap-cao.update',[$donvi->id_DV])}}" enctype="multipart/form-data">
                @method('PUT')
              	@csrf
                <div class="card-body">
