...
<div class="content">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thêm Khối Hành Chính</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{URL::to('/home')}}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{Route( 'hanh-chinh.index')}}">Danh Sách Khối Hành Chính</a></li>
              <li class="breadcrumb-item active">Thêm Khối Hành Chính</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
 ...
 <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{route('hanh-chinh.store')}}" enctype="multipart/form-data">
              	@csrf
                <div class="card-body">
